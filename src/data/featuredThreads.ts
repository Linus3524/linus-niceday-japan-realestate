...
// 這兩個分類名同時是「情境曝光規則」的依據（見 threadSearch.ts 的 isContextMatch）：
// 買房情境只撈得到這兩類，其餘一律視為租屋。改名時改這裡即可，不要另外寫死字串。
export const BUY_CATEGORY_LABEL = "日本買房";
export const CROSS_CATEGORY_LABEL = "Linus 知識系列";

export const threadCategories: ThreadCategory[] = [
  {
    label: CROSS_CATEGORY_LABEL,
    threads: [
  ...
  },
  {
    ...
    threads: [
      ...
      {
        url: "https://www.threads.com/@linus3524/post/DdLh2qyk9aN",
        keywords: [
          "寶藏車站",
          "辻堂",
          "つじどう",
