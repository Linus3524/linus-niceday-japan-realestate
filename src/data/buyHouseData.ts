...
export const buyKnowledgeMeta = {
  ...
  notice: "銀行條件、稅額與自治體規則會變動，且依申請人與物件個別審査。簽約或投資前應向金融機構、自治體、司法書士、稅理士、建築士及消防單位確認最新書面條件。",
  officialSources: [
...
export const buyHouseFeeTerms: BuyHouseTermItem[] = [
  ...
  },
  {
    name: "物件調査費用",
    jpName: "物件調査費用、鑑界費",
    description: "在買賣或過戶前，針對土地邊界、建物結構耐震等進行的實地調査費用。某些公股台系銀行會強制要求買方支付外部估價公司的鑑定費（約 20 萬日圓）。",
    category: "fee"
  },
  {
    name: "仮審査",
...
export const buyHouseLoanSteps: BuyHouseFlowStep[] = [
  ...
  },
  {
    step: "2",
    title: "遞交買付與簽訂買賣契約",
    description: "假審査通過後，透過仲介向賣方提出買付申請書。條件談成後，雙方簽署「不動產買賣契約書」，並由宅建士進行「重要事項說明」。此時需支付 5%〜10% 訂金。",
    timing: "買付成立後約 1～2 週",
    payment: "手付金、印紙稅；仲介費依約定",
  ...
  },
  {
    step: "4",
    title: "簽訂貸款契約（金消契約）",
    description: "本審査通過後，借款人與銀行簽署「金錢消費貸借契約」。契約會確定貸款金額、利率、還款期限、每月還款方式與撥款日期。",
    timing: "本審通過後、交屋前",
...
export const taiwaneseBanks: TaiwaneseBankItem[] = [
  ...
  },
  {
    ...
    object: "具中華民國國籍，或具有台灣居留權。在日本設有分行，可提供海外對保與審査。",
  ...
  },
  {
    ...
    incomeAsset: "不設死板的固定資產數字，採個案審査，需提供完整的扣繳憑單與財力明細。",
  ...
  },
  {
    ...
    others: [
      ...
      "原始資料指出，對非居住者開戶與物件審査較嚴謹，尤其應在申請前確認獨棟與物件用途是否受理。"
    ],
  ...
  },
  {
    ...
    object: "個人：具中華民國或日本國籍，或具台灣居留權／日本永住權者。法人：於日本合法設立註冊法人。",
    ageLimit: "未列固定年齡上限，通常與還款期限一併評估。",
    incomeAsset: "未列統一固定門檻；須提供完整財力、所得與信用資料，由銀行個案審査。",
    signingReq: "一般要求親自前往東京分行辦理。",
    rentAccount: "無日本在留資格者為還款帳戶，出入金以海外匯款為主，且不提供網路銀行。",
    propertyReq: "原始資料記載新耐震（約 1984 年後）並須具確認／檢查相關文件，臨接道路寬度等條件亦會審査；建物面積未達 10 坪者另議。",
  ...
  },
  {
    ...
    object: "個人：具中華民國或日本國籍，或具台灣居留權／日本永住權者。法人：於日本合法設立註冊法人。",
    ageLimit: "未列固定年齡上限，通常與還款期限一併評估。",
    incomeAsset: "銀行依借保人資信、財力與不動產條件進行最終審査，原始資料未列固定數字門檻。",
    signingReq: "一般要求親自前往東京分行辦理。",
    rentAccount: "無日本在留資格者為還款帳戶，出入金以海外匯款為主，且不提供網路銀行。",
...
export const japaneseBanks: JapaneseBankItem[] = [
  ...
  },
  {
    ...
    note: "• 必須為正社員並加入日本社保與厚生年金。\n• 需提供 1-2 年在日源泉徵收票，對轉職次數及雇主企業規模審査較傳統與嚴格。"
  },
  {
  ...
  },
  {
    ...
    amountLimit: "年收入 7 - 8 倍",
    ageLimit: "配合還款年限綜合審査",
    note: "• 審査門檻低，不限單身或在日年限。一般作為初期在日買房過渡，待後續取得永住或個人信用提升後，再轉貸至三菱、三井等低息日系大銀行。"
  },
  {
    name: "あすか信用金庫 (Asuka)",
    rate: "變動 2.0%～",
...
export const ryokanRules = {
  ...
  requirements: [
    ...
    "客室須有足夠面積、通風、採光、照明、防濕及排水等衛生條件；浴室、廁所、洗面與給排水設備也須符合東京都條例及個案審査。",
...
const buyHouseQAItems: BuyHouseQAItem[] = [
  {
    ...
    answer: "外國人原則上可以在日本取得土地與建物所有權，買房本身通常不要求持有日本長期簽證；但仍可能涉及重要土地等調查法、農地法、外匯法令申報、本人確認與匯款審査等個別程序。購買不動產本身不會自動取得居留或永住資格；任何簽證規劃都應依實際活動內容向入管專業人士確認。"
  },
  {
  ...
  {
    question: "父母與子女一起買日本房子，怎麼設定共同持分才不容易被認定為贈與？",
  ...
  },
  {
    ...
    answer: "日本不動產屬於日本國內財產。即使父母與子女都住在台灣，子女繼承日本房屋或土地時，仍可能成為日本相續稅與申報的對象；若子女住在日本，課稅財產範圍還要再依國籍、在留資格與過去居住期間判斷。\n\n日本相續稅不是只看該棟房子的售價，而是先依日本規則評價遺產、扣除可認列債務等，再與整體基礎控除比較。申報期限原則上是知道死亡的翌日起 10 個月內；海外繼承人需要申報時，可能還要指定日本納稅管理人。",
    sources: [
...
const buyQAOrder = [
  ...
  "日本買房有類似台灣的「履約保證」制度嗎？",
  "日本有沒有「斡旋金」？出價可以講價講多少？",
  "貸款的「假審査」和「本審査」通過後，還可以隨意更換想買的物件嗎？",
  ...
  "為什麼地段越好、越新蓋的房子，算下來的利潤投報率（利回り）反而越低？",
  // 民宿用途
