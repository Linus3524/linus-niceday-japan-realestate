...
export const buyHouseDrawingTerms: BuyHouseTermItem[] = [
  ...
  },
  {
    name: "表面利回り",
    jpName: "表面投報率",
    description: "以一年預估租金收入除以物件購入價格計算的簡易收益率，通常未扣除管理費、修繕積立金、固定資產稅、管理委託費、空置、修繕與購入規費。適合初步比較，不能直接視為屋主實拿報酬。",
    category: "drawing",
  ...
  },
  {
    name: "実質利回り・実際利回り",
    jpName: "實質／實際投報率",
    description: "將持有期間的經常支出及購入成本納入後估算的收益率。計算口徑沒有單一固定格式，至少應確認管理費、修繕積立金、固定資產稅、管理委託費、保險、空置及維修成本是否已計入。",
    category: "drawing",
    warning: "比較不同物件時必須使用相同期間與費用口徑；未來空置、租金變動及突發修繕仍屬估算風險。"
  }
];
...
export const buyHouseFeeTerms: BuyHouseTermItem[] = [
  {
    name: "買付申込書",
    jpName: "購屋意向書",
    description: "買方向賣方提出購入價格、付款方式、簽約與交屋日期等條件的書面申請。一般用來表達購買意願與協商條件，但是否成立買賣契約仍須依文件內容、雙方合意及後續正式契約判斷。",
    category: "fee"
  },
  {
    name: "売買契約書印紙代",
    jpName: "買賣契約書印花稅",
    description: "製作紙本不動產買賣契約書時，依契約記載金額適用印紙稅。由哪一方負擔、各自保存幾份正本及實際稅額，應在簽約前確認；電子契約的處理亦應依當時法規與文件形式判斷。",
    category: "fee"
  },
  {
    name: "手付金",
    ...
    category: "fee",
    warning: "買方不能把任何貸款未通過都直接視為手付金必然退還；必須確認融資特約的金融機構、金額、申請義務及解除期限。"
  },
  {
    name: "残代金",
    jpName: "交屋尾款",
...
export const buyHouseLoanSteps: BuyHouseFlowStep[] = [
  {
    step: "➊",
    title: "初步諮詢與貸款「假審査」（事前審査）",
    description: "在挑選物件前或看到中意物件時，先向銀行提出基本資料（年收、公司背景、在留資格等）進行假審査。假審査通常在 3-7 個工作天內核准，可以提早確認您的借貸額度與利率區間，保障交易安全。",
    points: [
  ...
  },
  {
    ...
    warning: "⚠️ 重要：合約中必須載明「融資特約（貸款特約）」，約定若最終銀行貸款本審査未通過，買方可以無條件解約並退還全額手付金，避免訂金被沒收的風險！"
  },
  {
    step: "➌",
    title: "正式申請貸款「本審査」（本審査）",
    description: "簽約完成後，正式向銀行提交本審査申請。本審査比假審更為嚴格，銀行會對買方個人信用、以及交易物件的實際「擔保評價（鑑定估價）」進行全面性的實質審査，通常需時 2 至 3 週。",
    points: [
  ...
  },
  {
    step: "➍",
    title: "簽訂貸款契約（金消契約）",
    description: "貸款本審査順利核准後，借款人需與撥款銀行簽署正式的「金錢消費貸借契約（簡稱金消契約）」，這是一份具有法律效益的借貸合約，詳細約定放款金額、還款利率、期限與撥款日期（決算日）。"
  },
  {
    step: "➎",
    title: "銀行撥款、支付尾款與辦理過戶",
    description: "撥款當天，買賣雙方、仲介、銀行專員及司法書士會在貸款銀行會合。銀行將貸款資金撥入買方帳戶，買方隨即將買房尾款（殘代金）、仲介費、司法書士代書費、登記稅費等轉帳給賣方與相關單位。司法書士現場確認無誤後，會即時送件辦理塗銷賣方原抵押權及移轉所有權登記。",
    points: [
  ...
  },
  {
    step: "➏",
    title: "交屋點交與領取鑰匙",
    description: "過戶手續完成且資金入帳確認後，賣方現場移交實體鑰匙、大樓設備說明書。約 2-3 週後，買方會收到由法務局核發的「登記識別情報（產權所有權狀）」，正式完成日本買房置產！"
  }
];
  ...
  },
  {
    ...
    table: {
      ...
      notes: [
        ...
        "表內為制度概要，實際能否經營須以物件地址及所在地主管機關的個案確認結果為準。"
      ]
    }
  }
];
