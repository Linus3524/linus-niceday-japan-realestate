...
export const buyHouseFeeTerms: BuyHouseTermItem[] = [
  ...
  },
  {
    name: "手付金",
    jpName: "簽約訂金",
    description: "簽訂買賣契約時由買方支付、交屋時充作價款一部分的款項。常見比例約為成交價的 5%～10%，但並非法定固定比例。簽約後能否解除及手付金如何處理，須區分手付解除、融資特約與違約解除。",
    category: "fee",
