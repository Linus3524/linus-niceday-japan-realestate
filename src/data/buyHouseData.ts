...
const buyHouseQAItems: BuyHouseQAItem[] = [
  ...
  {
    question: "買了日本投資物件，但我長期住在海外、沒有日本在留身分，租金收入仍要繳日本所得稅嗎？",
    answer: "要。是否持有日本簽證或在留卡，不是判斷租金是否課稅的標準。只要出租的是日本境內不動產，租金原則上就是日本的國內來源所得；人在海外、屬於日本稅法上的非居住者，仍可能需要在日本申報所得稅。\n\n【租客是法人】\n若承租人是公司或其他法人，支付租金時原則上須按租金總額預扣 20.42%（所得稅及復興特別所得稅），再把扣除後的金額付給海外房東。這筆 20.42% 是預先繳納的稅款，不代表最後一定要負擔這麼多。\n\n【租客是個人】\n個人租客若是為自己或親屬居住而承租，支付住宅租金時可以免辦上述預扣。若不是供本人或親屬居住，例如作為事業用途，仍可能有預扣義務，不能一律視為免扣。\n\n【申報後是否能退回】\n非居住者可在年度確定申告中，依日本規定以租金收入扣除可認列的必要經費，例如管理委託費、管理費、修繕費、固定資產稅、火災保險、建物折舊及符合條件的借款利息等，計算實際的不動產所得，再扣抵已被預扣的稅款。若預扣的 20.42% 高於最終算出的所得稅，差額可申請退還；若不足，則須補繳。因此應稱為「確定申告後結算或退稅」，不是保證能把預扣款全部退回。\n\n長期居住海外的屋主，通常還需要指定居住於日本的納稅管理人，由其代收稅務文件、辦理申報、繳稅與接收退稅。實際可列經費、折舊與居住地租稅協定的適用，建議交由熟悉非居住者不動產所得的日本稅理士確認。",
    sources: [
...
const buyQAOrder = [
  ...
  "買了日本投資物件，但我長期住在海外、沒有日本在留身分，租金收入仍要繳日本所得稅嗎？",
