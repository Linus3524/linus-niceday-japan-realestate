...
export const buyHouseDrawingTerms: BuyHouseTermItem[] = [
  ...
  },
  {
    name: "専有面積",
    jpName: "室內專有面積（不含陽台）",
    description: "指區分所有建物中個別住戶可專有使用的面積，通常不含陽台與共用部分。廣告常採壁芯面積，登記可能採內法面積，兩者數値不同，貸款與稅務判斷時須確認採用基準。",
    category: "drawing"
  },
  {
    name: "バルコニー面積",
...
export const taiwaneseBanks: TaiwaneseBankItem[] = [
  {
    ...
    propertyReq: "新耐震基準（1981年6月後建）。不承作木造一戶建或築齡過老公寓，對物件擔保價値評估較嚴。",
  ...
  },
  {
    ...
    others: [
      ...
      "缺點是「貸款門檻高達 1.5 億日圓」，幾乎只承作高淨値的豪宅、整棟公寓或高資產法人，且屋齡限制嚴格在 20 年內。"
    ]
  },
  {
    name: "兆豐商業銀行",
    ...
    others: [
      "個人申請通常須備近 3 年所得稅報稅資料、護照、身分或在留文件、信用調査報告及交易確認資料。",
  ...
  },
  {
    ...
    rentAccount: "無日本在留資格者為還款帳戶，出入金以海外匯款為主，且不提供網路銀行。",
    propertyReq: "原始資料記載新耐震（約 1984 年後）並須具確認／檢査相關文件，臨接道路寬度等條件亦會審査；建物面積未達 10 坪者另議。",
...
export const japaneseBanks: JapaneseBankItem[] = [
  ...
  },
  {
    ...
    amountLimit: "年收入 7 - 8 倍",
    ageLimit: "配合還款年限綜合審査",
    note: "• 審査門檻低，不限單身或在日年限。一般作為初期在日購屋過渡，待後續取得永住或個人信用提升後，再轉貸至三菱、三井等低息日系大銀行。"
  },
  {
    name: "あすか信用金庫 (Asuka)",
    rate: "變動 2.0%～",
...
export const ryokanRules = {
  ...
  steps: [
    { name: "事前諮詢", desc: "在簽約、施工或變更用途前，持設計圖向轄區保健所、消防署確認；同時由建築士査核用途地域、建築基準法、既存不適格與用途變更程序。" },
    ...
    { name: "現場與消防確認", desc: "保健所會進行現場檢査；消防法令適合性也須經轄區消防署確認。兩者的時程與檢査方式依案件及自治體安排，勿假設一定是聯合檢査。" },
    { name: "獲得許可與開業", desc: "通過檢査後，核發「旅館業營業許可證」，即可全年 365 天營運，不受 180 天天數限制。" }
  ],
  requirements: [
...
export const buyHouseQAs: BuyHouseQAItem[] = [
  {
    ...
    answer: "外國人原則上可以在日本取得土地與建物所有權，買房本身通常不要求持有日本長期簽證；但仍可能涉及重要土地等調査法、農地法、外匯法令申報、本人確認與匯款審査等個別程序。購買不動產本身不會自動取得居留或永住資格；任何簽證規劃都應依實際活動內容向入管專業人士確認。"
  },
  {
    ...
    sources: [{ label: "日本國稅廳：共同購屋出資與持分", url: "https://www.nta.go.jp/taxes/shiraberu/taxanswer/zoyo/4411.htm" }]
  },
  {
  ...
  },
  {
    ...
    answer: "先把總取得成本拆清楚：買賣價金、由誰負擔的貸款本金，以及直接構成取得對價的支出，再依可證明的實際負擔比例討論登記持分。父母替子女支付的頭期款、尾款或日後代繳子女應負擔的貸款，都可能形成新的贈與判斷。\n\n不要先登記各半，再事後補借據；也不要只看誰是貸款名義人，而忽略實際由誰還款。簽約前應讓司法書士確認登記持分，並讓日本稅理士檢査出資、貸款與持分是否一致。跨境資金還要保存匯款水單、親屬關係、資金來源、借貸或贈與文件。",
    sources: [
  ...
  },
  {
    ...
    answer: "不能。帶租約投資房在出售時不安排買方進入室內看房；現租客仍在居住，買方不能要求進屋確認。購入前只能以租賃契約、修繕紀錄、過往照片、設備表、管理文件與收益資料査核，並把無法完整確認室內狀況列入價格與修繕風險。"
  },
  {
  ...
  },
  {
    ...
    answer: "這是房地產市場的鐵律：\n\n1. 房價分母大：熱門黃金地段（如港區、澀谷、新宿）的土地地價高昂，新築或極新物件的造價與溢價高，這使得「購入價格（分母）」非常龐大，雖然租金也貴，但租金的漲幅跟不上房價的溢價，計算下來的表面投報率自然偏低（通常在 3% ~ 4.5% 之間）。\n\n2. 資產保値與抗跌性：高投報率（例如 8% ~ 10%）的物件往往位於偏遠郊區、人口流出嚴重、或是屋齡 40 年以上的木造老屋。這類物件雖然租金投報高，但面臨「空置期長、轉手極難、資產價値快速貶値」的巨大風險。市中心的新屋雖然投報率低，但空置率極低、極易轉手、且土地資產具備強大的保値與未來增値空間，適合追求資金安全與穩定資產配置的投資者。"
  },
  {
    question: "為什麼越新的房子，投報率 (利回り) 好像越低？",
    answer: "日本新房購入成本高昂，折舊率少、設施新。高購屋成本 (分母大) 會直接拉低租金回報率百分比。\n\n日本房產價値隨屋齡折舊，但租金下降速度不如房價跌速快。因此中高屋齡 (約20-30年) 的房子若維護得當，因為購置價格低，算下來的利潤投報率往往會比新蓋的房子高。但要注意老房有較高的維護修繕基金支出。"
  },
  {
...
export const buyBudgetModifiers: BuyBudgetModifier[] = [
  ...
  // Building Structure / Amenities
  {
    ...
    type: "plus",
    category: "building",
    description: "20層以上超高層地標性豪宅，公設極度豪華（如24小時管理員、高空大廳、客房服務），資產保値性極強"
  },
  {
  ...
  },
  {
    ...
    type: "minus",
    category: "age",
    description: "折舊接近底部，土地持分價値高於地上建物價値，多數大樓管線需要大幅拉皮或更新，入手價格極具優勢"
  }
];
