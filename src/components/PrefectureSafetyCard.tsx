  ...
  return (
    <div className="space-y-3 font-sans [font-family:var(--font-sans)]">
      ...
      <div className="border border-[#DDE3DF] bg-white p-4 sm:p-5 space-y-4">
        ...
        {/* 精度說明 */}
        <div className="flex items-start gap-2.5 border border-[#DDE3DF] bg-[#F5F8F6] px-3.5 py-2.5">
          <Info className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#66736C]" />
          <p className="text-[11px] leading-relaxed text-[#66736C]">
            日本官方除東京都外未公開町丁目犯罪月報，故本區採<strong className="font-bold text-[#1A2A22]">都道府県廣域指標</strong>為基準；右側街區活動則依周邊 500m 環境推估，供綜合評估參考。
          </p>
        </div>
