...
> = {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "公益財團法人 不動產流通推進中心《中古マンション価格査定マニュアル》：日本不動產流通推進中心編訂之官方査定基準。",
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "不動產銷售圖面（マイソク／販売図面）多為日本不動產流通市場之公開或仲介募集文件。若您上傳之圖檔或合約草案中載有特定個人私密資訊（如原所有權人姓名、現住戶個資、私人聯絡電話或手寫簽名），強烈建議您於上傳前先行塗黑或遮蔽。",
          "絕不建立個人檔案：本站絕不會利用圖面內之個人資訊進行個人身分比對或建立個人檔案。本站亦絕不將您上傳之圖紙、物件資料或對話紀錄出售、轉讓或出租給任何第三方不動產仲介業者、金融機構或行銷廣告商。",
  ...
  disclaimer: {
    ...
    title: "資訊免責聲明",
    introduction:
      "本站致力於透過日本官方實價大數據、査定基準教科書與演算法模型，將複雜的日本不動產市況與交易規則透明化；但網頁所有內容、試算與 AI 診斷均為初步研究與決策輔助性質，絕不能取代日本法定專業人士針對個案提供之正式專業意見與現場調查。",
    sections: [
      {
        title: "一般資訊與非專業意見性質",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "本站圖紙健檢、大樓修繕積立金充足度評估、管理體制檢驗及持分稅費概算，均為演算法模型之初步篩檢，絕不能取代日本《宅地建物取引業法》第 35 條規定由合格「宅地建物取引士」交付並面對面說明之《重要事項說明書（35條書面）》、管委會總會議事錄、重要事項調査報告書，亦不能取代合格「一級建築士」之耐震診斷與建物劣化檢查。",
        ],
      },
      {
        title: "買賣實價成交行情的資料來源",
      ...
      },
      {
        title: "租金相場之資料來源",
        paragraphs: [
          "租金行情資料取自 At Home 全國各行政區與格局之公開家賃相場，採直近刊登物件之代表值建立快照。資料反映刊登階段之募集條件，非最終契約租金。同一行政區內，屋齡、站距、樓層、座向及設備均會造成價差，實際租金請以當期招租圖面為準。",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "日本住宅貸款減稅（住宅ローン控除）與不動產取得稅減免之法定專有面積門檻（40㎡ 或 50㎡ 以上）一律以法務局「登記簿謄本內法面積」為準。若圖面壁芯面積為 40.0～42.0㎡，扣除牆厚後登記簿內法面積極可能跌破 40㎡ 而無法適用減稅。交易前務必向經紀人調閱建物登記謄本確認。",
        ],
      },
      {
        title: "審查、融資與交易結果",
