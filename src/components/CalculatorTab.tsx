            ...
            >
              ...
              >
                {calcMode === "listing" ? (
                  <>
                    <p>
                      剛拿到仲介提供的物件圖紙，想更清楚掌握各項細節嗎？只要上傳單張圖檔或 PDF，系統會自動辨識物件類型，為您客觀整理出關鍵數據與條款重點。
                    </p>
                    <p>
                      <strong>買賣物件</strong>：比對日本國土交通省周邊實價登錄行情，換算台灣習慣的每坪單價；協助整理每月管理費與修繕積立金負擔、檢視社區規模與修繕積立金充足度，並客觀試算實質投報率與交屋初期費用。<br />
                      <strong>租賃物件</strong>：評估租金合理區間、試算入住初期費用，提醒敷引等特殊特約條款注意事項，並同步標示周邊生活圈與通勤路線。
                    </p>
                  </>
                ) : calcMode === "rent" ? (
                  <>
